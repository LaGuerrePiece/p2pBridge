<template>
  <div class="self-start grid gap-5 lg:col-span-2 w-full row-span-2 order-2 lg:order-none">
    ...
    <div class="col-span-full grid grid-cols-5 gap-y-4 max-h-[450px] overflow-scroll p-1 pb-3">
